		...
		Route::group(['prefix' => 'settings'], function () {
            ...
            */
			Route::group(['prefix' => 'editor'], function() {
				Route::get( '/',					[ 'as' => 'admin.editor.get', 					'uses' => 'EditorController@getEditor'     				]);
				Route::get( '/add-new',				[ 'as' => 'admin.editor.add.get', 				'uses' => 'EditorController@getAddEditor'   			]);
				Route::post( '/add-new',			[ 'as' => 'admin.editor.add.post', 				'uses' => 'EditorController@postAddEditor'   			]);
				Route::get( '/edit/{id}',			[ 'as' => 'admin.editor.edit.get', 				'uses' => 'EditorController@getEditEditor'   			]);
				Route::post( '/edit/{id}',			[ 'as' => 'admin.editor.edit.post', 			'uses' => 'EditorController@postEditEditor'   			]);
				Route::get( '/data',				[ 'as' => 'admin.editor.data.get', 				'uses' => 'EditorController@getEditorData' 				]);
				Route::get( '/delete/{id}',			[ 'as' => 'admin.editor.delete.get', 			'uses' => 'EditorController@getDeleteEditor'  			]);
				Route::post( '/delete/{id}',		[ 'as' => 'admin.editor.delete.post', 			'uses' => 'EditorController@postDeleteContact'  		]);
			});
