                    ...
                    <div class="row">
                        <div class="col-md-4">
                                        ...
                                        @if(isset($categories))
                                            @foreach($categories as $cat)
                                                <option value="{{$cat->category_id}}"
                                                        @if(isset($category)) @if($cat->category_id == $category->parent) selected @endif @endif>{{$cat->name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            {{--<div class="form-group {{ $errors->has('file') ? ' has-error' : '' }}">--}}
                                {{--<div class="col-md-12">--}}
                                    {{--<label for="file">Images</label> <span class="required" aria-required="true">*</span>--}}
                                    {{--<div class="row">--}}
                                        {{--<div class="col-md-12">--}}
                                            {{--<div class="fileinput fileinput-new" data-provides="fileinput">--}}
                                                {{--<div class="fileinput-preview thumbnail" data-trigger="fileinput"style="width: 100%; height: 150px;">--}}
                                                    {{--@if(isset($category) && intval($category->media_id))<img src="{{ asset('public/uploads/medium/' . $category->media->guid ) }}">@endif--}}
                                                {{--</div>--}}
                                                {{--<div>--}}
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-comments"></i>Categories
                                    </div>
                                    <div class="tools">
            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    var oTable = $('#table').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "{{ route('admin.category.data.get') }}",
                        },
                        columns: [
