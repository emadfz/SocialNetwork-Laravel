                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.posts.add.get', 'post_type='.\Request::get('post_type')) }}" class="btn sbold green">
                                                Add New
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var oTable = $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.posts.data.get', ['post_type='.\Request::get('post_type')]) }}",
                },
                columns: [
                    {data: 'post_title', name: 'posts_translations.post_title'},
                    @if(isset($language_available))
                        @foreach($language_available as $l)
                        {
                            data: '{{{ $l }}}', name: 'post.id', orderable: false, searchable: false
                        },
                        @endforeach
                    @endif
