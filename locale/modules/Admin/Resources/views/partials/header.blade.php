...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>8 Digital | Dashboard</title>
                                    ...
                                    <li>
                                        <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('public/assets/admin/layouts/layout4/img/avatar2.jpg') }}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('public/assets/admin/layouts/layout4/img/avatar3.jpg') }}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('public/assets/admin/layouts/layout4/img/avatar1.jpg') }}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
