...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('posts_translations', function (Blueprint $table) {
            ...
            $table->text('post_indication');
            $table->text('post_definition');
            $table->text('post_operative_time');
            $table->text('post_anesthesia');
            $table->text('post_scars');
            $table->text('post_labs_needed');
            $table->text('post_convalescence');
            $table->text('post_final_result');
            $table->text('post_nb');
            $table->text('post_price');
