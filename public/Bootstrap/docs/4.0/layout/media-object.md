...
Change the order of content in media objects بواسطة modifying the HTML itself, or بواسطة adding some custom flexbox CSS to set the `order` property (to an integer of your choosing).
