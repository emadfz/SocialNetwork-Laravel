...
Add `.table-sm` to make tables more compact بواسطة cutting cell padding in half.
...
Responsive tables allow tables to be scrolled horizontally with ease. Make any table responsive across all viewports بواسطة adding `.table-responsive` class on `.table`. Or, pick a maximum breakpoint with which to have a responsive table up to بواسطة adding `.table-responsive{-sm|-md|-lg|-xl}`.
