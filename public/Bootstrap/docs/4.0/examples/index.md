...
Examples that focus on implementing uses of built-in components provided بواسطة Bootstrap.
...
<div class="row bd-examples">
  ...
  <div class="col-6 col-md-4">
    ...
    <p>Build a more custom page بواسطة narrowing the default container and jumbotron.</p>
  </div>
</div>
