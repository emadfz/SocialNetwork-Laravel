...
Toggle a working modal demo بواسطة clicking the button below. It will slide down and fade in from the top of the page.
...
Utilize the Bootstrap grid system within a modal بواسطة nesting `.container-fluid` within the `.modal-body`. Then, use the normal grid system classes as you would anywhere else.
...
Below is a live demo followed بواسطة example HTML and JavaScript. For more information, [read the modal events docs](#events) for details on `relatedTarget`.
...
<table class="table table-bordered table-striped table-responsive">
  ...
  <tbody>
    <tr>
      <td>show.bs.modal</td>
      <td>This event fires immediately when the <code>show</code> instance method is called. If caused بواسطة a click, the clicked element is available as the <code>relatedTarget</code> property of the event.</td>
    </tr>
    <tr>
      <td>shown.bs.modal</td>
      <td>This event is fired when the modal has been made visible to the user (will wait for CSS transitions to complete). If caused بواسطة a click, the clicked element is available as the <code>relatedTarget</code> property of the event.</td>
    </tr>
    <tr>
      <td>hide.bs.modal</td>
