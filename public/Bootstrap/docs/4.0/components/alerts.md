...
| `$().alert('close')` | Closes an alert بواسطة removing it from the DOM. If the `.fade` and `.show` classes are present on the element, the alert will fade out before it is removed. |
