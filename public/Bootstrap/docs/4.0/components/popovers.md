...
One way to initialize all popovers on a page would be to select them بواسطة their `data-toggle` attribute:
...
Gives an element's popover the ability to be shown. **Popovers are enabled بواسطة default.**
