...
A bug is a _demonstrable problem_ that is caused بواسطة the code in the repository.
...
0. **Validate and lint your code** &mdash; [validate your HTML](https://html5.validator.nu/)
   ...
   problem isn't caused بواسطة a simple error in your own code.
...
Sometimes bugs reported to us are actually caused بواسطة bugs in the browser(s) themselves, not bugs in Bootstrap per se.
...
documentation source files and is managed separately بواسطة the Bootstrap Core Team.
...
**IMPORTANT**: بواسطة submitting a patch, you agree to allow the project owners to
...
بواسطة contributing your code, you agree to license your contribution under the [MIT License](LICENSE).
بواسطة contributing to the documentation, you agree to license your contribution under the [Creative Commons Attribution 3.0 Unported License](docs/LICENSE).
