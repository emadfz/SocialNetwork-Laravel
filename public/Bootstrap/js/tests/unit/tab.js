$(function () {
  ...
  QUnit.test('should activate element بواسطة tab id', function (assert) {
    assert.expect(2)
  ...
  QUnit.test('should activate element بواسطة tab id in ordered list', function (assert) {
    assert.expect(2)
  ...
  QUnit.test('should activate element بواسطة tab id in nav list', function (assert) {
    assert.expect(2)
  ...
  QUnit.test('should activate element بواسطة tab id in list group', function (assert) {
    assert.expect(2)
